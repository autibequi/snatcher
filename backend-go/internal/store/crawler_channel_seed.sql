-- Seeds idempotentes: crawlers (searchterm) + canais com audiência/tópicos.
-- Manter em sincronia com internal/db/migrations/0124_seed_crawlers_channels_topics.sql
